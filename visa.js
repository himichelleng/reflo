var merchant_search_api = (function() {
    'use strict';
    ...
    function merchant_search_api(options) {
     ...
     * Merchant Search
     * @method
     * @name merchant_search_api#merchantSearch
     * @param {string} xClientTransactionId - 
     * @param {} merchantSearchPOSTPayload - Resource body for Merchant Search
     *
     */
    merchant_search_api.prototype.merchantSearch = function(parameters) {
        ...
        var path = '/merchantsearch/v1/search';
    ...
    return merchant_search_api;
})();

exports.merchant_search_api = merchant_search_api;